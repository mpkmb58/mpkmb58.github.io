                ...
                <div className="row">
                    <div className="col-md-6 px-lg-5">
                        <div className="text">
                            ...
                            <a target="_blank" rel="noreferrer" href="https://goo.gl/maps/E6wDLDQx7UTtNYws5" >
                        ...
                        <div className="text">
                            ...
                            <div className="social-media">
                                <div className="socmed-col-1 d-flex flex-column">
                                    <a href="https://page.line.me/731qklyo?openQrModal=true" target="_blank" rel="noreferrer" className="p-2 d-flex align-items-center text-grey">
                                        <div className="boxed me-3">
                                            <img loading="lazy" src={logoline} alt="Logo sosmed" />
                                        </div>Line
                                    </a>
                                    <a href="https://www.youtube.com/channel/UCdHt1R2mPVPZkP_Zr0eKGFw" target="_blank" rel="noreferrer" className="p-2 d-flex align-items-center text-grey">
                                        <div className="boxed me-3">
                                            <img loading="lazy" src={logoyoutube} alt="Logo sosmed" />
                                        </div> Youtube
                                    </a>
                                    <a href="https://twitter.com/mpkmb_ipb" target="_blank" rel="noreferrer" className="p-2 d-flex align-items-center text-grey">
                                        <div className="boxed me-3">
