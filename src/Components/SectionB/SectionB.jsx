...
function SectionB() {
    ...
    const logoConsole = <div className="logo-console-wrapper rotate-bg-logo">
        <img loading="lazy" className="bg-logo" src={logoconsole} alt="logo-bg" />
    </div>

    const logoFAQ = <div className="rotate-bg-logo"><img className="mx-3 bg-logo" src={logofaq} alt="logo-bg" /> </div>
