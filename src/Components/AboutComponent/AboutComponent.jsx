        ...
        <div>
            <div className="container pt-5">
                ...
                <div className="row justify-content-between">
                    <div class=" about-nav-wrapper col-lg-2 py-3 d-flex flex-lg-column justify-content-lg-start justify-content-center align-items-center bg-grey">
                        <div onClick={() => showContent1(props.content1Title, props.content1)} className='shadow-md hash btn-blue btn rounded-pill my-2 py-1'><h5 className="m-0">{props.content1Hash}</h5></div>
                        <div onClick={() => showContent2(props.content2Title, props.content2)} className='shadow-md hash btn rounded-pill my-2 py-1'><h5 className="m-0"> {props.content2Hash}</h5></div>
                        <div onClick={() => showContent3(props.content3Title, props.content3)} className='shadow-md hash btn rounded-pill my-2 py-1'><h5 className="m-0">{props.content3Hash}</h5></div>
                        <div onClick={() => showContent4(props.content4Title, props.content4)} className='shadow-md hash btn rounded-pill my-2 py-1'><h5 className="m-0">{props.content4Hash}</h5></div>
                    </div>
