        ...
        },
        {
            ...
            isi: <div>
                ...
                <div className="text-center my-3  d-flex justify-content-center">
                    <img src={logo} alt="Logo Mahardika Cakrabinaya" className="logo-akt" />
                </div>
        ...
        },
        {
            ...
            isi: <div className="row justify-content-center">
                <div class="col-md-4 mb-4  text-center ">
                    <img src={logoBiru} alt="Logo Mahardika Nawesana" className="logo-kelompok" />
                </div>
                <div class="col-md-4  mb-4 text-center ">
                    <img src={logoHijau} alt="Logo Mahardika Reswara" className="logo-kelompok" />
                </div>
                <div class="col-md-4 mb-4   text-center ">
                    <img src={logoUngu} alt="Logo Mahardika Arunakara" className="logo-kelompok" />
                </div>
                <div class="col-md-4 mb-4  text-center ">
                    <img src={logoMerah} alt="Logo Mahardika Wirakarsa" className="logo-kelompok" />
                </div>
                <div class="col-md-4  mb-4  text-center ">
                    <img src={logoKuning} alt="Logo Mahardika Kalawa" className="logo-kelompok" />
                </div>
            </div>,
            linkStatus: false
        }
